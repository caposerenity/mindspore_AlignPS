...
class UnlabeledMatchingLayer(nn.Cell):
    """
    ...
    def __init__(self, queue_size=5000, feat_len=256):
        ...
        self.register_buffer("queue", mindspore.tensor.zeros(queue_size, feat_len))
        self.register_buffer("tail", mindspore.tensor(0))
...
class UnlabeledMatchingFullLayer(nn.Cell):
    """
    Unlabeled matching of OIM loss function.
    """
