from mmdet.core import bbox2roi, bbox2result_reid

import mindspore
import mindspore.nn as nn
class PersonSearchRoIHead2Input1():
    def forward(
        self,
        x,
        img_metas,
    ...
    def _bbox_forward(self, x, rois):
        ...
        bbox_feats1 = mindspore.ops.adaptive_max_pool2d(bbox_feats, 1)
        if self.with_shared_head:
            bbox_feats = self.shared_head(bbox_feats)
            bbox_feats = mindspore.ops.adaptive_max_pool2d(bbox_feats, 1)
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False, use_rpn=True):
